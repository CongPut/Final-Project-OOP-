...
public class EditSubject extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Course)
                            .addComponent(Cid)
                            .addComponent(ClassCode, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(ClassCode, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if(tabel.getSelectedRow()== -1){
            ...
            model.setValueAt(Course.getText(), tabel.getSelectedRow(), 0);
            model.setValueAt(Cid.getText(), tabel.getSelectedRow(), 1);
            model.setValueAt(ClassCode.getText(), tabel.getSelectedRow(), 2);
        }
        reset();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel)tabel.getModel();
        if(Course.getText().trim().equals("") || Cid.getText().trim().equals("") || ClassCode.getText().trim().equals("")){
           JOptionPane.showMessageDialog(null, "You Miss One of the Content !");
        } else {
           model.addRow(new Object[]{Course.getText(), Cid.getText(), ClassCode.getText()});
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel)tabel.getModel();
        Course.setText(model.getValueAt(tabel.getSelectedRow(),0).toString());
        Cid.setText(model.getValueAt(tabel.getSelectedRow(),1).toString());
        ClassCode.setText(model.getValueAt(tabel.getSelectedRow(),2).toString());
